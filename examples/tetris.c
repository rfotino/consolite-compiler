...
void play_game() {
  ...
  while (1) {
    ...
    // rotate the current piece. Input ID 1 is the up arrow.
    // BUG: INPUT(KEY_UP) isn't working reliably.
    up_pressed = INPUT(1);
